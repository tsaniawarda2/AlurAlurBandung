...
<head>
  ...
  <<<<<<< HEAD <!-- font awesome cdn link -->
    ...
    =======
    >>>>>>> 7f38537c6825c712bb075130a691b0b9397e42cb
              ...
              <div class="profile-info">
                <div class="d-flex align-items-center justify-content-center mb-30">
                  <div class="profile-image text-center">
                    ...
                    <?php } ?>
                    <<<<<<< HEAD <!-- <img src=" ../assets/img/<?= $lpr_user['foto_profile']; ?>" alt="foto_user" /> -->
                    =======
                    >>>>>>> 7f38537c6825c712bb075130a691b0b9397e42cb
                  </div>
                </div>
          ...
          <div class="row mt-3">
            ...
            <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mb-4">
              ...
              <div class="footer-logo mb-2">
                <<<<<<< HEAD <img src="../assets/img/LapssPUTIH.svg" alt="" height="30px">
                  =======
            ...
            <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mb-0 contact">
              <!-- Links -->
              <<<<<<< HEAD <h6 class="text-uppercase fw-bold text-white">Social Network</h6>
                =======
