...
$users = query("SELECT users.bpjs_ketenagakerjaan, nama, id_user FROM users");
          ...
          <div class="row ">
            <div class="col-lg-12 ">
              <div class="card-style mb-30">
                <h6 class="mb-10">Dokumen BPJS Ketenagakerjaan</h6>
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td id="act-icon">
                            <div class="action">
                              <a href="detail.php?id=<?= $lu["bpjs_ketenagakerjaan"]; ?>">
